...
% --- A full display heading opens the next part (use \clearpage before it
% if you'd rather start it on a fresh page) ---------------------------------
...
Every page carries a quiet website line and a zero-padded \accentword{01 / 02}
page indicator. The cover's metadata block is driven by \verb|\doctype{}|,
\verb|\revision{}|, \verb|\docyear{}| and \verb|\website{}|.
