...
revision, or the build ID when it's unset — bottom-left, and a zero-padded
\accentword{01 / 02} page indicator square in the bottom-right corner. The
cover's metadata block is driven by \verb|\doctype{}|, \verb|\revision{}|,
\verb|\docyear{}| and \verb|\website{}|.
